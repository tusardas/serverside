...
public class GeneralPasswordEncoder implements PasswordEncoder{
    Logger log = LoggerFactory.getLogger(GeneralPasswordEncoder.class);
    private final String SECURITY_SALT = "XXXXXXXXXX";
